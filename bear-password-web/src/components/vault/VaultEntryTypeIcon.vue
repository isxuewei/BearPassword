...
import type { VaultEntryIconType } from '@/utils/vaultEntryDisplay'

withDefaults(
  defineProps<{
    type: VaultEntryIconType
    size?: number
  }>(),
  {
    size: 22
